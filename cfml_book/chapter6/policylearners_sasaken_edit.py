...
@dataclass
class CateBasedGradientPolicyLearner_by_sk:
    ...
    def fit(self, dataset: dict, dataset_test: dict, test_q_x_a_hat_1, test_q_x_a_hat_0) -> None:
        x, a, r = dataset["x"], dataset["a"], dataset["r"]
        ...
        # start policy training
        q_x_a_1 = test_q_x_a_hat_1 # q_x_a_1 = dataset_test["q_x_a_1"]
        q_x_a_0 = test_q_x_a_hat_0 # q_x_a_0 = dataset_test["q_x_a_0"]
        for _ in range(self.max_iter):
            self.nn_model.train()
